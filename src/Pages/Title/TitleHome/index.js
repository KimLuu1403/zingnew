...
// import { asyncGetDetailZingNewContent } from "../../Home/store/action";
// import { selectDetailZingNewContent } from "../../Home/store/selector";
const TitleHome = (props) => {
  // // action
  // const { detailsZingNewContentAction } = props;
  // // data
  // const { detailZingNewContent } = props;
  ...
  return (
    <div className="title container">
      ...
      <img
        ...
        className="img-title"
      />
      {/* <h1>{detailZingNewContent.id}</h1>
      <h2>{detailZingNewContent.title}</h2>
      <h3>{detailZingNewContent.desciption}</h3>
      <h4>{detailZingNewContent.content}</h4>
      <img src={detailZingNewContent.img} alt="" /> */}
    </div>
  );
};
// // data State to Props
// const mapStateToProps = createStructuredSelector({
//   detailZingNewContent: selectDetailZingNewContent,
// });

// //action contact with API
// const mapDispatchToProps = (dispatch) => ({
//   detailsZingNewContentAction: (payload) =>
//     asyncGetDetailZingNewContent(dispatch)(payload),
// });
// const withConnect = connect(mapStateToProps, mapDispatchToProps);

// export default compose(withConnect)(TitleHome);
